...
<div region="west" title="导航菜单" class="left">
    <div class="sidebar-menu" id="menuBox">
        ...
        <ul id="oneMenuId_004" class="nav nav-list  menu-second in collapse " >
            <li><a href="javascript:void(0)" class="menuItem" menuName="目标良品率设置" menuId="4001" menuUrl="/toQueryTarget">目标良品率设置</a></li>
            <li><a href="javascript:void(0)" class="menuItem" menuName="单个目标良品率设置" menuId="4002" menuUrl="/toQueryTargetoc">单个目标良品率设置</a></li>
        </ul>
    </div>
</div>
